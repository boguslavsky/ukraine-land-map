...
// Масив об'єктів файлів із кольорами для кожної області
const FILES = [
...
export default function App() {
    ...
    useEffect(() => {
        ...
        // 2. Зчитування збережених паїв із localStorage при старті
    ...
    return (
        <div style={{ position: 'relative', height: '100vh', width: '100vw' }}>
            ...
            >
                <TileLayer
                    attribution='&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> | Границі громад: <a href="https://data.humdata.org/dataset/cod-ab-ukr" target="_blank" rel="noopener noreferrer">OCHA HDX</a>'
                ...
                {/* Завантажені локально куплені паї */}
                {ownedPlots.map((plot) => (
                    <Marker
                ...
                {/* Тимчасовий маркер пошуку координат */}
                {selectedCoords && (
                    <>
                        <Marker position={selectedCoords} icon={searchIcon}>
                            <Popup>
                                Обрана точка:<br />
